...
public class IncomeStatement {
	...
	public IncomeStatement(int id, String fatura, String parcela, String data1,
			String data2, String leituradata, String est, int vazio, int ponta,
			int cheia, int foravazio, double valor, String companhia) {
		super();
		this.id = id;
		this.fatura = fatura;
	...
	public IncomeStatement(String fatura, String parcela, String data1,
			String data2, String leituradata, String est, int vazio, int ponta,
			int cheia, int foravazio, double valor, String companhia, int id) {
		super();
		this.id = id;
		this.fatura = fatura;
		this.parcela = parcela;
