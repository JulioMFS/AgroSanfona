...
<nav class="navbar navbar-expand-md navbar-dark"
	...
	<ul class="primary-nav">
		<li class="left"><a href="<%=request.getContextPath()%>/list"
			class="nav-link">Banco Extracto</a></li>

		<li class="right"><a href="<%=request.getScheme()%>://<%=request.getServerName()%>:<%=request.getServerPort()%>/AgroSanfonaWeb/"
